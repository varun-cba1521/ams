...
<aside class="left-side sidebar-offcanvas">
	...
	<?php
	    ...
	    if($this->context->module->id == 'student')
		 ...
		 else if($this->context->module->id == 'followup') 
	    	 echo $this->render('menu/followup');
	...
	<!--
	<div style="margin-left: 25px; position: fixed;">
	<?= Html::a(Html::img(Yii::$app->request->baseUrl.'/images/edusec.png', ['width'=>'170px;', 'height'=>'60px']), Yii::$app->homeUrl, ['class' => 'logo', /*'style' => ((\Yii::$app->language == 'ar') ? 'padding: 14px 50px !important;' : '')*/]) ?>
	</div>
	-->
