...
?>
		...
		<?php endif; ?>
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-red">
                                <div class="inner">
                                    <h3>
                                       <?php
									   $getcount = app\models\StuFollowup2::findBySql('select * from stu_followup_2 where followup_id in (select max(followup_id) from stu_followup_2 group by student_id having pending=0)')->all();
										/* $getcount = new Query();
				...
				<?= Html::a(Yii::t('app', 'More info').' <i class="fa fa-arrow-circle-right"></i>', ['/followup/stufollowupmaster/index'], ['target' => '_blank', 'class' => 'small-box-footer']); ?>
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-yellow">
                                <div class="inner">
                                    <h3>
                                        <?= app\models\CounselInfo::find()->where('emp_id > 0')->count(); ?>
                                    </h3>
                                    <p>
				...
				<?= Html::a(Yii::t('app', 'More info').' <i class="fa fa-arrow-circle-right"></i>', ['counsel/view'], ['target' => '_blank', 'class' => 'small-box-footer']); ?>
					...
					<div style="font-size:20px;padding-bottom:10px;">&nbsp;&nbsp;<i class="fa fa-inbox">&nbsp;&nbsp;</i><?php echo Yii::t('app', 'Institute Details') ?></div>
                    <div class="row">
                        <div class="col-lg-3 col-xs-6">
                            <!-- small box -->
