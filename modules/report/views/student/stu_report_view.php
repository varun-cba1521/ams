...
<div class="box box-info box-solid">
   ...
   <div class="box-body">
	...
	<div class="col-xs-12 col-sm-4 col-lg-4">
      ...
      <div class="row">
	  <div class="col-xs-12 col-sm-4 col-lg-4">
		 <?= $form->field($model,'report_status')->dropDownList(ArrayHelper::map(\app\modules\student\models\StuStatus::findAll(['is_status'=>0]),'stu_status_id','stu_status_name'), ['prompt' => Yii::t('stu', '--- Select Status ---')]);?>
	</div>
	<div class="col-xs-12 col-sm-4 col-lg-4">
