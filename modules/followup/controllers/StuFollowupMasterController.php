...
use app\modules\followup\models\StuInfo;
use app\modules\followup\models\StuGuardians;
use app\modules\followup\models\StuAddress;
use app\modules\followup\models\StuDocs;
use app\modules\followup\models\StuMasterSearch;
...
class StuFollowupMasterController extends \yii\web\Controller
{
    ...
    public function actionCreate()
    {
		...
		$stud_uniq_no = \app\modules\followup\models\StuInfo::find()->max('stu_unique_id');
		$uniq_id = NULL;
