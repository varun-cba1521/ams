...
<div class="col-xs-12">
  <div class="col-lg-12 col-sm-12 col-xs-12 no-padding"><h3 class="box-title"><i class="fa fa-plus"></i>Add Follow-up</h3></div>
</div>
...
<div class="stu-master-create">
  ...
  <div class="box-success box view-item col-xs-12 col-lg-12">
    <div class="stu-master-form">
     <p class="note"><?php echo  'Fields with'; ?> <span class="required"> <b style=color:red;>*</b></span> <?php echo 'are required'; ?>.</p>
