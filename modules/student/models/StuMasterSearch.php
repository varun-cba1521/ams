...
class StuMasterSearch extends StuMaster
{
	...
	$dataProvider->sort->attributes['user_login_id'] = [
		...
		$dataProvider->sort->attributes['stu_email_id'] = [
        'asc' => ['stu_info.stu_email_id' => SORT_ASC],
        'desc' => ['stu_info.stu_email_id' => SORT_DESC],
        ];
		$dataProvider->sort->attributes['stu_mobile_no'] = [
        'asc' => ['stu_info.stu_mobile_no' => SORT_ASC],
        'desc' => ['stu_info.stu_mobile_no' => SORT_DESC],
        ];
		$dataProvider->sort->attributes['stu_birthplace'] = [
        'asc' => ['stu_info.stu_birthplace' => SORT_ASC],
        'desc' => ['stu_info.stu_birthplace' => SORT_DESC],
        ];
