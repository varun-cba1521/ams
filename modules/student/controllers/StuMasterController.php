...
class StuMasterController extends Controller
{
	...
	$feesCatModel = new FeesCollectCategory();
	$feesTranModel = new FeesPaymentTransaction();

        return $this->render('view', [
            'model' => $model, 'info' => $info, 'address' => $address, 'guardian' => $guardian, 'stu_docs' => $stu_docs, 'feesTranModel'=>$feesTranModel, 'feesCatModel'=>$feesCatModel, 'followup' => $followup, 'stuid' => $id, 'empinfo' => $empinfo,
        ]);
    }
