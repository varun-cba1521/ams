	...
	<?php Pjax::begin([ 'enablePushState' => false ]); ?>
		...
		'columns' => [
			...
			*/
			...
			[
			'label' => Yii::t('stu', 'Email ID'),
			'attribute' => 'stu_email_id',
			'value' => 'stuMasterStuInfo.stu_email_id',
	 	    ],
			...
			*/
			[
			'label' => Yii::t('stu', 'Mobile No.'),
			'attribute' => 'stu_mobile_no',
			'value' => 'stuMasterStuInfo.stu_mobile_no',
	 	    ],
			...
			[
			'label' => Yii::t('stu', 'Location'),
			'attribute' => 'stu_birthplace',
			'value' => 'stuMasterStuInfo.stu_birthplace',
	 	    ],
